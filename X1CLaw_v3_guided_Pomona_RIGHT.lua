...
--location home
local home_lat = 33.9324472 *3.14159265/180 -- in rad
local home_long = -117.6311919*3.14159265/180 --in rad
local heading = -108.9*3.14159265/180 --in degrees, how many degrees east of north runway is (bonus box to the right of runway if runway at 0 deg)
